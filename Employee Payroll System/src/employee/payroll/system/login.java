...
import employee.payroll.system.model.EmployeeDetails;
...
public static Integer empId = null;
...
//                cmd_LoginActionPerformed(evt);
        ...
        jPanel2.add(cmd_Signup);
        cmd_Signup.setBounds(300, 470, 70, 30);
    ...
    private void cmd_SignupActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        // TODO add your handling code here:
        signup x = new signup();
        x.setVisible(true);
...
//    			"http://localhost:8080/findEmployee");
...
//    		//EmployeeDetails empDetails = mapper.readValue(jsonRspn.toString(), EmployeeDetails.class);
//    		Employee empDetails = mapper.readValue(jsonRspn.toString(), Employee.class);
...
//    		empDetails.setId((long)2);
//    		empDetails.setUserName("abc");
//    		empDetails.setPassword("abc");
//    		
//    		String payload = mapper.writeValueAsString(empDetails);
//    		StringEntity  entity = new StringEntity (payload,
//    				ContentType.APPLICATION_JSON);
//
//            //httpClient = HttpClientBuilder.create().build();
//            HttpPost request = new HttpPost("http://localhost:8080/addEmployee");
...
//    		httpClient.getConnectionManager().shutdown();
    		...
    		empDetails.setUserName(txt_username.getText());
    		empDetails.setPassword(txt_password.getText());
    		DefaultHttpClient httpClient = new DefaultHttpClient();
            ...
            //httpClient = HttpClientBuilder.create().build();
            HttpPost request = new HttpPost("http://localhost:8080/validateEmployee");
            request.setEntity(entity);
          ...
          new InputStreamReader((response.getEntity().getContent())));
			...
			ArrayList<Employee> employees = null;
			//EmployeeDetails empDetails = mapper.readValue(jsonRspn.toString(), EmployeeDetails.class);
			empDetails = mapper.readValue(jsonRspn.toString(), Employee.class);
		   ...
		   if (empDetails.getId() == 0) {
		        JOptionPane.showMessageDialog(null, "User is not signed up yet. Please sign up first.");
		    } 
        //String sql = "select id,username,password,division from Users Where (username =? and password =? and division =?)";
    	String sql = "select id,username,password,division from Users";
            
                //"select * from Employeeinfo where username=? and password=? and division=? and id=?";
        try{
           int count = empDetails.getId().intValue();
           empId = empDetails.getId();
