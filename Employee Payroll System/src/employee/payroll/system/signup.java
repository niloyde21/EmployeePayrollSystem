...
public class signup extends javax.swing.JFrame {
	...
	private void initComponents() {
		...
		jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Employee Registration",
...
//        jLabel3.setText("Date of Birth :");
		...
		jLabel1.setBounds(30, 100, 70, 14);
		jLabel2.setText("Password :");
		jLabel2.setBounds(30, 150, 70, 14);
		txt_userName.setBounds(100, 100, 132, 30);
		txt_password.setBounds(100, 150, 132, 30);
		jPanel3.add(jLabel1);
		jPanel3.add(jLabel2);
		...
		cmd_save.setBounds(30, 200, 120, 50);
		...
		jButton1.setBounds(150, 200, 120, 50);
...
//        );
	...
	private void cmd_saveActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_cmd_saveActionPerformed
		...
		try {
			...
			payload = mapper.writeValueAsString(empDetails);
			entity = new StringEntity(payload, ContentType.APPLICATION_JSON);

			// httpClient = HttpClientBuilder.create().build();
			request = new HttpPost("http://localhost:8080/validateEmployee");
		...
		if (empDetails.getId() != 0) {
			JOptionPane.showMessageDialog(null, "User is already signed up. Please login.");
		} else {
			request = new HttpPost("http://localhost:8080/addEmployee");
			request.setEntity(entity);
